...
*/
createMenuItem('Pizza', 7, 'Brunch');

createMenuItem('Chips', 2, 'Brunch');

createMenuItem('Burger', 5, 'Brunch');
...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function(assignTitle){
    if(assignTitle === 'student' || assignTitle === 'teacher'){
      return burger.price * 0.75;
    } else if(assignTitle === 'public'){
...
function getReviewByIndex(reviews, aNumber) {

	return `${reviews[aNumber].name} gave the restaurant a ${reviews[aNumber].rating} star review, and their feedback was: ${reviews[aNumber].feedback}`;
